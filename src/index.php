...
<head>
  ...
  <script type="text/javascript">
      ...
      })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=103584855', 'ym');

      ym(103584855, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
  </script>
  <noscript><div><img src="https://mc.yandex.ru/watch/103584855" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
  <!-- /Yandex.Metrika counter -->
</head>
    ...
    <section class="ip-top-section">
      <div class="container ip-top-section__container">
        <div class="content-block content-block_ip-title">
          ...
          <div class="dark-description-block">от 95 000 рублей в месяц</div>
